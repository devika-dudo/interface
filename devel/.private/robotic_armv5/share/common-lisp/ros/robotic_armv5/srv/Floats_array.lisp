...
(cl:in-package robotic_armv5-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <Floats_array-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Floats_array-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotic_armv5-srv:<Floats_array-request> is deprecated: use robotic_armv5-srv:Floats_array-request instead.")))

(cl:ensure-generic-function 'req-val :lambda-list '(m))
(cl:defmethod req-val ((m <Floats_array-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotic_armv5-srv:req-val is deprecated.  Use robotic_armv5-srv:req instead.")
  (req m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Floats_array-request>)))
  ...
  "robotic_armv5/Floats_arrayRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Floats_array-request)))
  "Returns string type for a service object of type 'Floats_array-request"
  "robotic_armv5/Floats_arrayRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Floats_array-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Floats_array-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotic_armv5-srv:<Floats_array-response> is deprecated: use robotic_armv5-srv:Floats_array-response instead.")))

(cl:ensure-generic-function 'res-val :lambda-list '(m))
(cl:defmethod res-val ((m <Floats_array-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotic_armv5-srv:res-val is deprecated.  Use robotic_armv5-srv:res instead.")
  (res m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Floats_array-response>)))
  ...
  "robotic_armv5/Floats_arrayResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Floats_array-response)))
  "Returns string type for a service object of type 'Floats_array-response"
  "robotic_armv5/Floats_arrayResponse")
